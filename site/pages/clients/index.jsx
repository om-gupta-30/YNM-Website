...
const clientsData = [
  ...
  { id: "6", name: "Tom Tailor", logo: "/assets/brand-logos/tom-tailor-sportswear-logo.png", industry: "Retail & Fashion", location: "Global", yearsOfPartnership: 3, relationship: "International partner for store fit-outs, metal fixtures, and finishes. We support their retail presence with custom fabrication and quality coatings.", products: ["Metal Fabrication", "Decorative Paints", "Custom Fixtures"], testimonial: "YNM's custom solutions and export reliability have made them a dependable global partner." },
  { id: "7", name: "NCC Limited", logo: "/assets/brand-logos/ncc-logo.png", industry: "Construction & Infrastructure", location: "India", yearsOfPartnership: 5, relationship: "Key supplier for construction materials including industrial paints, structural steel, and fabrications. We support NCC's diverse projects across the country.", products: ["Industrial Paints", "Structural Steel", "Epoxy Coatings"], testimonial: "Consistent quality and on-time delivery. YNM understands the demands of large-scale construction." },
  { id: "8", name: "NSL Group", logo: "/assets/brand-logos/nsl-logo.png", industry: "Diversified Manufacturing", location: "India", yearsOfPartnership: 4, relationship: "Partner for paints, metal fabrication, and industrial solutions across the group's manufacturing and infrastructure units.", products: ["Industrial Paints", "Metal Fabrication", "Safety Solutions"], testimonial: "A responsive and quality-focused supplier. Our partnership has grown over the years." },
  { id: "9", name: "HCL", logo: "/assets/brand-logos/hcl-logo.png", industry: "IT & Technology", location: "India", yearsOfPartnership: 4, relationship: "Supplier for campus infrastructure, furniture, and finishes. We support HCL's offices and facilities with durable, quality products.", products: ["Decorative Paints", "School & Office Furniture", "Metal Fabrication"], testimonial: "YNM's products and service have been instrumental in maintaining our facility standards." },
  ...
  { id: "12", name: "NTPC", logo: "/assets/brand-logos/ntpc-logo.png", industry: "Power & Energy", location: "India", yearsOfPartnership: 5, relationship: "Partner for industrial coatings, structural steel, and metal fabrication at power plants and installations. We meet the strict standards of the power sector.", products: ["Industrial Paints", "Structural Steel", "Epoxy Coatings"], testimonial: "Technical compliance and timely delivery. YNM understands our sector's requirements." },
  { id: "13", name: "Power Grid", logo: "/assets/brand-logos/powergrid-logo.png", industry: "Power Transmission", location: "India", yearsOfPartnership: 5, relationship: "Supplier of industrial paints, structural components, and fabrications for substations and transmission infrastructure across India.", products: ["Industrial Paints", "Structural Steel", "Metal Fabrication"], testimonial: "A dependable partner for our extensive network. Quality and delivery have always been consistent." },
  { id: "14", name: "Hyundai Glovis", logo: "/assets/brand-logos/hyundai-glovis-logo.png", industry: "Logistics & Automotive", location: "Global", yearsOfPartnership: 3, relationship: "International partner for warehouse and facility solutions including paints, metal fabrication, and industrial products. We support their logistics operations.", products: ["Industrial Paints", "Metal Fabrication", "Structural Steel"], testimonial: "YNM's export capability and product quality make them a reliable global supplier." },
  { id: "15", name: "NPCI International", logo: "/assets/brand-logos/npci-logo.png", industry: "Finance & Payments", location: "India", yearsOfPartnership: 3, relationship: "Partner for office and facility infrastructure including furniture, paints, and finishes. We support their workspace and operational needs.", products: ["Decorative Paints", "Office Furniture", "Metal Fabrication"], testimonial: "Professional and quality-driven. YNM has been a valued partner for our facility requirements." },
  ...
  { id: "18", name: "Aparna Constructions", logo: "/assets/brand-logos/aparna-constructions.png", industry: "Real Estate & Construction", location: "India", yearsOfPartnership: 5, relationship: "Long-term supplier for paints, metal work, and fabrications across residential and commercial projects. We are proud to be part of Aparna's quality-focused developments.", products: ["Decorative Paints", "Structural Steel", "Gates & Railings"], testimonial: "Consistent quality and a partnership approach. YNM has been integral to our project execution." },
];
