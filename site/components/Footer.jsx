...
function Footer({ footerData: propFooterData }) {
  ...
  const phone = footerData?.footerPhone || "+91 96765 75770 / +91 88850 02183";
      ...
      <div className="ft-content">
        ...
        <div className="ft-col">
          ...
          <ul className="ft-links">
            {quickLinks.map((link) => (
              <li key={link.label}>
                <Link href={link.href} className="ft-link" aria-label={`${link.label} - Footer navigation`}>
                  {link.label}
                </Link>
              </li>
            ))}
