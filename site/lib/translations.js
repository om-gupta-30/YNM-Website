...
export const translations = {
  en: {
    ...
    hero: {
      ...
      tagline3: "Trusted by Clients Across 50+ Countries",
    ...
    products: {
      ...
      description: "Premium quality products manufactured in-house and exported to clients across 50+ countries worldwide",
      explore: "Explore",
    ...
    employees: {
      ...
      fallback: [
        { role: "Chief Executive Officer (CEO)", department: "Executive Leadership", text: "At YNM Safety, we're committed to manufacturing excellence and global expansion. Our vision is to be the leading manufacturer and exporter, delivering quality products that exceed expectations across 50+ countries." },
  ...
  hi: {
    ...
    hero: {
      ...
      tagline3: "50+ देशों में ग्राहकों द्वारा विश्वसनीय",
    ...
    products: {
      ...
      description: "प्रीमियम गुणवत्ता के उत्पाद जो घर में निर्मित हैं और दुनिया भर के 50+ देशों में ग्राहकों को निर्यात किए जाते हैं",
    ...
    usp: {
      ...
      subtitle: "दुनिया भर के 50+ देशों में ग्राहकों द्वारा विश्वसनीय",
      benefits: [
        ...
        { title: "वैश्विक निर्यात नेटवर्क", description: "हम एशिया, अफ्रीका और मध्य पूर्व में 50+ देशों में निर्यात करते हैं। हमारी अनुभवी निर्यात टीम सहज अंतर्राष्ट्रीय वितरण के लिए दस्तावेजीकरण, रसद और सीमा शुल्क निकासी संभालती है।" },
    ...
    employees: {
      ...
      fallback: [
        { role: "मुख्य कार्यकारी अधिकारी (सीईओ)", department: "कार्यकारी नेतृत्व", text: "YNM मेगा इंडस्ट्रीज में, हम निर्माण उत्कृष्टता और वैश्विक विस्तार के लिए प्रतिबद्ध हैं। हमारी दृष्टि अग्रणी निर्माता और निर्यातक बनने की है, जो 50+ देशों में अपेक्षाओं से अधिक गुणवत्तापूर्ण उत्पाद प्रदान करता है।" },
...
translations.te = mergeWithEn({
  ...
  hero: { title: "YNM మెగా ఇండస్ట్రీస్", since: "2013 నుండి • వినిర్మాణం మరియు ఎగుమతి ఉత్కృష్టత", tagline1: "వినిర్మాణ ఉత్కృష్టత, గ్లోబల్ రీచ్", tagline2: "రోడ్ మార్కింగ్ పెయింట్స్, ఫ్యాబ్రికేషన్స్ మరియు ఫర్నిచర్", tagline3: "50+ దేశాలలో క్లయింట్లచే విశ్వసించబడుతోంది", tagline4: "2013 నుండి నాణ్యత వినిర్మాణం", exploreProducts: "ఉత్పత్తులు అన్వేషించండి", yearsExperience: "సంవత్సరాల అనుభవం", projectsDelivered: "ప్రాజెక్టులు పూర్తయ్యాయి", exportCountries: "ఎగుమతి దేశాలు", happyClients: "సంతృప్త క్లయింట్లు" },
  ...
  products: { tag: "మా ఉత్పత్తులు", title: "మేము ఏమి తయారు చేస్తాము", description: "ఇంట్లో తయారు చేయబడిన మరియు ప్రపంచవ్యాప్తంగా 50+ దేశాలకు ఎగుమతి చేయబడిన ప్రీమియం నాణ్యత ఉత్పత్తులు", explore: "అన్వేషించండి", viewAll: "అన్ని ఉత్పత్తులు చూడండి", paintsTitle: "ప్రీమియం పెయింట్స్", paintsDesc: "ప్రతి ఉపరితలానికి అధిక-నాణ్యత పారిశ్రామిక మరియు అలంకార పెయింట్స్।", fabricationTitle: "మెటల్ ఫ్యాబ్రికేషన్", fabricationDesc: "కస్టమ్ స్టీల్ మరియు మెటల్ ఫ్యాబ్రికేషన్ సొల్యూషన్లు।", furnitureTitle: "స్కూల్ ఫర్నిచర్", furnitureDesc: "ఎడ్యుకేషనల్ సంస్థల కోసం ఎర్గోనామిక్ మరియు మన్నికైన ఫర్నిచర్।", safetyTitle: "భద్రతా పరికరాలు", safetyDesc: "పారిశ్రామిక ఉపయోగం కోసం ప్రీమియం భద్రతా గియర్।" },
  usp: { tag: "మా గురించి", title: "YNM మెగా ఇండస్ట్రీస్ గురించి", subtitle: "ప్రపంచవ్యాప్తంగా 50+ దేశాలలో క్లయింట్లచే విశ్వసించబడుతోంది" },
...
translations.gu = mergeWithEn({
  ...
  hero: { title: "YNM મેગા ઇન્ડસ્ટ્રીઝ", since: "2013થી • ઉત્પાદન અને નિકાસ ઉત્કૃષ્ટતા", tagline1: "ઉત્પાદન ઉત્કૃષ્ટતા, ગ્લોબલ રીચ", tagline2: "રોડ માર્કિંગ પેઇન્ટ્સ, ફેબ્રિકેશન્સ અને ફર્નિચર", tagline3: "50+ દેશોમાં ગ્રાહકો દ્વારા વિશ્વાસ", tagline4: "2013થી ગુણવત્તાયુક્ત ઉત્પાદન", exploreProducts: "ઉત્પાદનો અન્વેષણ કરો", yearsExperience: "વર્ષનો અનુભવ", projectsDelivered: "પ્રોજેક્ટ્સ પૂર્ણ", exportCountries: "નિકાસ દેશો", happyClients: "સંતુષ્ટ ગ્રાહકો" },
...
translations.ml = mergeWithEn({
  ...
  hero: { title: "YNM മെഗാ ഇൻഡസ്ട്രീസ്", since: "2013 മുതൽ • നിർമ്മാണവും എക്‌സ്‌പോർട്ട് ശ്രേഷ്ഠതയും", tagline1: "നിർമ്മാണ ശ്രേഷ്ഠത, ആഗോള എത്തിച്ചേരൽ", tagline2: "റോഡ് മാർക്കിംഗ് പെയിന്റുകൾ, ഫാബ്രിക്കേഷനുകൾ, ഫർനിച്ചർ", tagline3: "50+ രാജ്യങ്ങളിൽ ക്ലയന്റുകളാൽ വിശ്വസിക്കപ്പെടുന്നു", tagline4: "2013 മുതൽ ഗുണമേന്മയുള്ള നിർമ്മാണം", exploreProducts: "ഉത്പന്നങ്ങൾ പര്യവേക്ഷണം ചെയ്യുക", yearsExperience: "വർഷങ്ങളുടെ പരിചയം", projectsDelivered: "പ്രോജക്റ്റുകൾ നിറവേറ്റി", exportCountries: "എക്‌സ്‌പോർട്ട് രാജ്യങ്ങൾ", happyClients: "സന്തുഷ്ട ക്ലയന്റുകൾ" },
...
translations.pa = mergeWithEn({
  ...
  products: { tag: "ਸਾਡੇ ਉਤਪਾਦ", title: "ਅਸੀਂ ਕੀ ਨਿਰਮਾਣ ਕਰਦੇ ਹਾਂ", description: "ਘਰੇ ਲੂੰ ਨਿਰਮਿਤ ਅਤੇ ਦੁਨੀਆ ਭਰ ਦੇ 50+ ਦੇਸ਼ਾਂ ਨੂੰ ਨਿਰਯਾਤ ਕੀਤੇ ਗੁਣਵੱਤਾਪੂਰਨ ਉਤਪਾਦ", explore: "ਗੋਤਾਓ", viewAll: "ਸਭ ਉਤਪਾਦ ਦੇਖੋ", paintsTitle: "ਪ੍ਰੀਮੀਅਮ ਪੇਂਟ", paintsDesc: "ਹਰ ਸਤਹ ਲਈ ਉੱਚ-ਗੁਣਵੱਤਾ ਵਾਲੀਆਂ ਉਦਯੋਗਿਕ ਅਤੇ ਸਜਾਵਟੀ ਪੇਂਟ।", fabricationTitle: "ਧਾਤ ਨਿਰਮਾਣ", fabricationDesc: "ਕਸਟਮ ਸਟੀਲ ਅਤੇ ਧਾਤ ਨਿਰਮਾਣ ਹੱਲ।", furnitureTitle: "ਸਕੂਲ ਫਰਨੀਚਰ", furnitureDesc: "ਵਿਦਿਅਕ ਸੰਸਥਾਵਾਂ ਲਈ ਅਰਗੋਨੋਮਿਕ ਅਤੇ ਟਿਕਾਊ ਫਰਨੀਚਰ।", safetyTitle: "ਸੁਰੱਖਿਆ ਉਪਕਰਣ", safetyDesc: "ਉਦਯੋਗਿਕ ਵਰਤੋਂ ਲਈ ਪ੍ਰੀਮੀਅਮ ਸੁਰੱਖਿਆ ਗਿਅਰ।" },
  usp: { tag: "ਸਾਡੇ ਬਾਰੇ", title: "YNM ਮੈਗਾ ਇੰਡਸਟਰੀਜ਼ ਬਾਰੇ", subtitle: "ਵਿਸ਼ਵ ਭਰ ਦੇ 50+ ਦੇਸ਼ਾਂ ਵਿੱਚ ਗਾਹਕਾਂ ਦੁਆਰਾ ਭਰੋਸੇਯੋਗ" },
...
translations.or = mergeWithEn({
  ...
  hero: { title: "YNM ମେଗା ଇଣ୍ଡଷ୍ଟ୍ରିଜ୍", since: "2013 ରୁ • ଉତ୍ପାଦନ ଏବଂ ରପ୍ତାନି ଉତ୍କୃଷ୍ଟତା", tagline1: "ଉତ୍ପାଦନ ଉତ୍କୃଷ୍ଟତା, ଜାତୀୟ ପହଞ୍ଚ", tagline2: "ରୋଡ୍ ମାର୍କିଂ ପେଣ୍ଟ୍, ଫ୍ୟାବ୍ରିକେସନ୍ ଏବଂ ଫର୍ନିଚର୍", tagline3: "50+ ଦେଶରେ ଗ୍ରାହକଙ୍କ ଦ୍ୱାରା ବିଶ୍ୱସ୍ତ", tagline4: "2013 ରୁ ଗୁଣବତ୍ତା ଉତ୍ପାଦନ", exploreProducts: "ଉତ୍ପାଦ ଅନ୍ୱେଷଣ କରନ୍ତୁ", yearsExperience: "ବର୍ଷର ଅଭିଜ୍ଞତା", projectsDelivered: "ପ୍ରୋଜେକ୍ଟ ସମ୍ପୂର୍ଣ୍ଣ", exportCountries: "ରପ୍ତାନି ଦେଶ", happyClients: "ସନ୍ତୁଷ୍ଟ ଗ୍ରାହକ" },
...
translations.ur = mergeWithEn({
  ...
  hero: { title: "YNM میگا انڈسٹریز", since: "2013 سے • مینوفیکچرنگ اور برآمدی فضیلت", tagline1: "مینوفیکچرنگ فضیلت، عالمی رسائی", tagline2: "سڑک مارکنگ پینٹس، فیبریکیشنز اور فرنیچر", tagline3: "50+ ممالک میں کلائنٹس کا اعتماد", tagline4: "2013 سے معیاری مینوفیکچرنگ", exploreProducts: "مصنوعات دریافت کریں", yearsExperience: "سالوں کا تجربہ", projectsDelivered: "پروجیکٹس مکمل", exportCountries: "برآمدی ممالک", happyClients: "خوش کلائنٹس" },
